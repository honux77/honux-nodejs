...
function e(str) {
    ...
    var msg2 = $._("To use Khan Academy you need to upgrade to a newer version or another web browser.");
    ...
    if (navigator.userAgent && 
        ...
        msg2 = $._("To use Khan Academy you need to disable compatibility mode by <a href='https://sites.google.com/a/khanacademy.org/forge/technical/how-to-disable-internet-explorer-compatibility-view'>following these instructions</a>.");
...
document.body.clientHeight ) ) {
    ...
    _li1ds.background = _li2ds.background = _li3ds.background = _li4ds.background = "transparent url('" + imgPath + "background_browser.png') no-repeat scroll left top";
    ...
    _ico1ds.background = "transparent url('" + imgPath + "browser_chrome.png') no-repeat scroll left top";
    ...
    _ico4ds.background = "transparent url('" + imgPath + "browser_ie.png') no-repeat scroll left top";
